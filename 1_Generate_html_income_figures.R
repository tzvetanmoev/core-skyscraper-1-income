...
# set to directory containingWID data
setwd("C:/Users/tzvet/Pictures/Kings MA/CORE RA/GlobalMarketInc")
WIDraw <- read_xlsx("wid_pretax_usd21_wide.xlsx", col_names = TRUE)

# setwd("~/Documents/Kings MA/NEW CORE RA/App 3 Intro")
WIDraw <- WIDraw %>% 
  select(-total_population, total_population) %>%
  select(-country_code, country_code)  %>%
  filter(year > 1979)
colnames(WIDraw) <- c("country", "year" ,"income1", "income2", "income3", "income4", 
                      "income5", "income6", "income7", "income8",
                      "income9", "income10", "mean", "population", "country_code")
...
countries_to_drop[16:20] <- c("World", "Saudi Arabia", "Singapore", "Hong Kong", "Libya")
...
for (k in st_year:end_year){ #
  ...
  cat("<body>")
  cat("\n") 
  cat("<div class = \"header\"> <center> Global Market Income Inequality - " ,paste(k),"</center> </div>", sep = "")
  cat("\n") 
  ...
  cat("<center>")
  cat("\n")    
  cat("		<title> Global Market Income Distribution | amCharts</title>")
  cat("\n")
  cat("")
  cat("\n")
  ...
  cat("							{")
  cat("\n")
  cat("							\"balloonText\": \"Taller blocks correspond to higher market income. Countries with larger populations are assigned thicker blocks. Colours correspond to how rich the country is in 1980, with poorer countries shaded red and richer countries shaded green. Try hovering over a block to learn more!\",")
  cat("\n")
  cat("							\"category\": \"X\",")
  cat("\n")
  cat("							\"dashLength\": 4,")
  ...
  cat("							\"stackType\": \"3d\",")
  cat("\n")
  cat("							\"title\": \"Annual Income (2021 USD)\",")
  cat("\n")
  cat("							\"maximum\": 400000,")
  cat("\n")
  ...
  cat("							\"size\": 20,")
  cat("\n")
  cat("							\"text\": \"Global Market Income Distribution ",paste(k),"\"", sep = "")
  cat("\n")
  cat("						}")
  cat("\n")
  cat("					],")
  ...
  cat("\n")
  cat(" <br/>")
  cat("Download the data in <a href=\"https://raw.githubusercontent.com/tzvetanmoev/GlobalMarketInc/master/wid_pretax_usd21_wide.xlsx\" download =\"download\"> xlsx </a> or <a href=\"https://raw.githubusercontent.com/tzvetanmoev/GlobalMarketInc/master/wid_pretax_usd21_wide.csv\" download =\"download\"> csv </a> formats, pick another year, or return to the <a href=\"https://tzvetanmoev.github.io/GlobalMarketInc/\">home</a> page to learn more about the project <br /> <br />")
  cat("\n")
  #cat(" <br/>")
  if (k == 1980){
  ...
  cat(" <br/> <br/>")
  cat("\n")
  cat("These are detailed figures, so they may take a little time to load. Taller  blocks correspond to higher market income. Countries with larger populations are assigned thicker blocks. Colours correspond to how rich the country is in 1980, with poorer countries shaded red and richer countries shaded green. Countries are ordered according to national income per capita in each year, while holding colours fixed from the 1980 ordering. Therefore,  with these figures we can see market income inequality within and across countries over time as well as changes in national income per capita. Try hovering over a block to learn more!")
  cat("\n")
  cat(" <br/> <br/>")
  cat("\n")
